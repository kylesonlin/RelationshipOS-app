          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 max-w-2xl mx-auto lg:mx-0">
            <div className="flex items-start gap-3 text-left">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  AI analyzes your email patterns to surface relationship insights
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 text-left">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Automatic meeting tracking and relationship scoring
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 text-left">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Visual network of your professional connections
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 text-left">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Get strategic insights about your relationships
                </p>
              </div>
            </div>
          </div>
            ...
            <CardHeader className="text-center space-y-4">
              ...
              <div>
                ...
                <CardDescription className="text-base mt-2">
                  Sign in with Google to unlock Gmail and Calendar integration
                </CardDescription>
              </div>
            </CardHeader>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <Button
                  ...
                  disabled={loading}
                  className="w-full h-12 text-base flex items-center justify-center gap-2 bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 hover:border-gray-400 transition-colors"
                >
                  {loading ? (
                    <>
                ...
                >
                  Preview Demo (No Account Required)
                </Button>
                <p className="text-xs text-center text-muted-foreground">
                  Demo mode shows sample data for exploration only
                </p>
              ...
              <div className="pt-4 border-t">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    No password required. Your Google data stays secure and private.
                  </p>
                </div>
              </div>
            </CardContent>
